...
logger.info('dynamic frame uploaded in bucket s3://my-glue-etl-project2025/parquet_output/ in parquet format ')
# Script generated for node S3 bucket
S3bucket_node3 = glueContext.write_dynamic_frame.from_options(
    ...
    format="glueparquet",
    connection_options={
        "path": "s3://my-glue-etl-project2025/parquet_output/",
        "partitionKeys": [],
    },
